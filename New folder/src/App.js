...
function TodoList() {
  ...
  const [inserTodo, {loading:loadingInsert}] = useMutation(InserTodo, {
    refetchQueries: [GetTodo]
  })
  ...
  const onClickItem = async(idx) => {
    ...
    await updateTodo({variables :{id:idx, is_done : !item.is_done}})
    console.log("item = ",!item.is_done)
    refetch()
    // const newList = [...list];
  ...
  const onChangeUserId = (e)=>{
    // console.log("idalam onchange =", e.target.value);
    if(e.target){
  ...
  return (
    ...
    <button type="button" onClick={onGetData}>Get data</button> */}
      <div className='container'>
        ...
        {/* button untuk melakukan filter berdasarkan id  */}
        {/* <h1 style={{display: "flex", alignItems: 'center',  justifyContent: "center"}}>
        {data?.todolist.length == 0 ?"Data Kosong" : null}
        </h1> */}
